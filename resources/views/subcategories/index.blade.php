...
<div class="flex flex-col md:flex-row md:items-center mb-6 gap-4">
    <h1 class="text-3xl font-bold text-gray-800 md:flex-1">Subcategorías</h1>
    <a href="{{ route('subcategories.create') }}" class="bg-gray-800 hover:bg-black text-white font-bold py-2 px-4 rounded text-center whitespace-nowrap shrink-0">
