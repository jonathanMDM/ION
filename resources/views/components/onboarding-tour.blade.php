        ...
        <div class="relative w-full max-w-lg">
            ...
            <div class="relative bg-slate-900 border border-white/10 rounded-[2.2rem] shadow-2xl overflow-hidden p-8 sm:p-10 text-center">
                <div class="mb-8 relative inline-block">
                    <div class="w-20 h-20 bg-blue-medium rounded-2xl flex items-center justify-center shadow-2xl mx-auto transform -rotate-12 border-4 border-white/5">
        ...
        <div class="relative bg-slate-900/95 backdrop-blur-2xl rounded-[1.2rem] sm:rounded-[1.8rem] shadow-[0_30px_100px_rgba(0,0,0,0.6)] border border-white/10 overflow-hidden">
            ...
            <div class="p-3 sm:p-6">
                ...
                <div class="flex items-center space-x-2 sm:space-x-3 mb-1 sm:mb-4">
                    <div class="w-6 h-6 sm:w-10 sm:h-10 bg-blue-medium rounded-lg sm:rounded-xl flex items-center justify-center shadow-lg transform -rotate-3 shrink-0">
                ...
                <div class="mt-2 sm:mt-6 flex flex-col space-y-1 sm:space-y-4">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex space-x-1.5 sm:space-x-2">
                            ...
                            <button id="btn-wait" class="hidden px-3 sm:px-5 py-1 sm:py-2 bg-blue-medium text-white rounded-lg sm:rounded-xl text-[9px] sm:text-[11px] font-black cursor-default opacity-80">
                                Esperando...
                            </button>
                        </div>
                    </div>
