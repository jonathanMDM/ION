...
<div class="max-w-7xl mx-auto pb-12">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8 group">
        <div class="flex items-center gap-5">
            <a href="{{ route('assets.index') }}" class="w-12 h-12 flex items-center justify-center rounded-2xl bg-white dark:bg-gray-800 shadow-sm border border-gray-100 dark:border-gray-700 text-gray-400 hover:text-blue-medium hover:shadow-md transition-all">
        ...
        <div class="lg:col-span-4 space-y-8">
                ...
                <div class="p-8">
                    <div class="space-y-6">
                        <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-900/40 rounded-3xl border border-gray-100 dark:border-gray-700">
                            ...
                            <div class="w-12 h-12 bg-indigo-50 dark:bg-indigo-900/30 rounded-2xl flex items-center justify-center text-blue-medium">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-3xl p-8 shadow-sm border border-gray-100 dark:border-gray-700">
                ...
                <div class="space-y-6">
                    ...
                    <div class="p-4 bg-indigo-50/30 dark:bg-indigo-900/10 rounded-2xl border border-blue-medium/100/50 dark:border-blue-medium/900/30">
                ...
                <div class="px-8 py-6 border-b border-gray-50 dark:border-gray-700 flex items-center justify-between">
                    ...
                    @if(Auth::user()->hasPermission('create_movements'))
                        ...
                        @elseif($asset->status == 'active')
                            <a href="{{ route('assets.assign', $asset->id) }}" class="px-5 py-2.5 bg-blue-medium hover:bg-blue-dark text-white font-black rounded-xl transition-all shadow-md shadow-blue-medium/20 flex items-center gap-2 text-[10px] uppercase tracking-widest">
                    ...
                    @if($asset->isAssigned())
                        ...
                        <div class="flex flex-col md:flex-row items-center gap-8 bg-emerald-50/50 dark:bg-emerald-900/10 p-6 rounded-3xl border border-emerald-100/50 dark:border-emerald-900/30">
                            ...
                            <div class="flex-1 text-center md:text-left">
                                ...
                                <a href="{{ route('employees.show', $assignment->employee->id) }}" class="text-xl font-black text-gray-900 dark:text-white hover:text-blue-medium transition-colors">{{ $assignment->employee->full_name }}</a>
    ...
    <div id="transferModal" class="fixed inset-0 bg-gray-900/90 backdrop-blur-sm overflow-y-auto h-full w-full hidden z-50 flex items-center justify-center p-4">
        <div class="relative w-full max-w-lg bg-white dark:bg-gray-800 rounded-[2.5rem] shadow-2xl border border-white/10 overflow-hidden">
            ...
            <form action="{{ route('asset-movements.store') }}" method="POST" class="p-8 space-y-6">
                ...
                <div class="flex items-center gap-4 p-4 bg-indigo-50 dark:bg-indigo-900/20 rounded-2xl border border-blue-medium/100 dark:border-blue-medium/900/30">
                    <div class="w-10 h-10 bg-white dark:bg-gray-800 rounded-xl flex items-center justify-center text-indigo-500 shadow-sm">
                        <i class="fas fa-map-pin"></i>
                    </div>
                    <div>
                        <p class="text-[10px] font-black text-blue-medium dark:text-indigo-400 uppercase tracking-widest">Ubicación Actual</p>
                ...
                <div>
                    ...
                    <select name="to_location_id" required class="w-full bg-gray-50 dark:bg-gray-900 border-gray-200 dark:border-gray-700 rounded-2xl py-3 px-4 font-black text-gray-800 dark:text-white focus:ring-2 focus:ring-blue-medium transition-all">
                ...
                <div>
                    ...
                    <textarea name="reason" rows="4" required class="w-full bg-gray-50 dark:bg-gray-900 border-gray-200 dark:border-gray-700 rounded-2xl py-4 px-5 text-sm font-medium focus:ring-2 focus:ring-blue-medium transition-all" placeholder="Describa por qué se realiza este cambio de ubicación..."></textarea>
                </div>
