...
<div class="max-w-5xl mx-auto pb-12">
    ...
    <div class="flex items-center justify-between mb-8">
        ...
        <a href="{{ route('assets.index') }}" class="flex items-center text-sm font-semibold text-gray-600 dark:text-gray-400 hover:text-blue-medium dark:hover:text-indigo-400 transition-colors">
    ...
    <form action="{{ route('assets.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="md:col-span-2">
                                ...
                                <input type="text" name="name" id="name" value="{{ old('name') }}" 
                                    class="w-full bg-gray-50 dark:bg-gray-900 border-gray-200 dark:border-gray-700 rounded-xl py-3 px-4 text-gray-700 dark:text-white focus:ring-2 focus:ring-blue-medium focus:border-transparent transition-all" 
                            ...
                            <div>
                                ...
                                <input type="number" name="quantity" id="quantity" min="1" value="{{ old('quantity', 1) }}"
                                    class="w-full bg-gray-50 dark:bg-gray-900 border-gray-200 dark:border-gray-700 rounded-xl py-3 px-4 text-gray-700 dark:text-white focus:ring-2 focus:ring-blue-medium focus:border-transparent transition-all" required>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="relative group">
                                    ...
                                    <input type="number" step="0.01" name="purchase_price" id="purchase_price" value="{{ old('purchase_price') }}"
                                        class="w-full bg-gray-50 dark:bg-gray-900 border-gray-200 dark:border-gray-700 rounded-xl py-3 pl-8 pr-4 text-gray-700 dark:text-white font-bold focus:ring-2 focus:ring-blue-medium focus:border-transparent transition-all" 
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div>
                                            ...
                                            <select name="cost_center_id" id="cost_center_id" 
                                                class="w-full bg-gray-100 dark:bg-gray-900 border-gray-200 dark:border-gray-700 rounded-xl py-3 px-4 text-gray-700 dark:text-white focus:ring-2 focus:ring-blue-medium transition-all">
        ...
        <div class="mt-12 pt-8 border-t border-gray-100 dark:border-gray-700">
            <div class="flex flex-col md:flex-row items-center justify-end gap-4">
                ...
                <button type="submit" 
                    class="w-full md:w-auto px-16 py-4 text-white font-black rounded-2xl transition-all shadow-xl transform hover:-translate-y-0.5 active:scale-95 flex items-center justify-center tracking-wide uppercase text-sm border-none cursor-pointer"
