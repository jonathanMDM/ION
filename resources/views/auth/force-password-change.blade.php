            ...
            function validate() {
                ...
                Object.keys(requirements).forEach(key => {
                    ...
                    if (req.re.test(val)) {
                        ...
                        liEl.className = 'flex items-center text-blue-dark font-medium';
                    } else {
                ...
                if (confirmVal.length > 0) {
                    if (val !== confirmVal) {
                        ...
                        confirmInput.classList.add('border-blue-medium/500');
                    }
                } else {
                    matchError.classList.add('hidden');
                    confirmInput.classList.remove('border-red-500', 'border-blue-medium/500');
                }
            }
