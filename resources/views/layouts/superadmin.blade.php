...
<body class="bg-gray-100 dark:bg-gray-900 transition-colors duration-200">
    ...
    <!-- Sidebar -->
    <div id="sidebar" class="sidebar-expanded fixed left-0 top-0 h-full text-slate-300 transition-all duration-300 z-50 sidebar-mobile-hidden md:sidebar-mobile-visible" style="background: var(--bg-rich-black); border-right: 1px solid rgba(255, 255, 255, 0.05);">
