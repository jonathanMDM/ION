...
<div class="max-w-xl mx-auto bg-white dark:bg-gray-800 p-4 md:p-6 rounded shadow transition-colors">
    ...
    <form action="{{ route('suppliers.update', $supplier->id) }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="name" id="name" value="{{ old('name', $supplier->name) }}" class="shadow appearance-none border dark:border-gray-600 rounded w-full py-2 px-3 text-gray-700 dark:text-white bg-white dark:bg-gray-700 leading-tight focus:outline-none focus:shadow-outline transition-colors" required>
        </div>
