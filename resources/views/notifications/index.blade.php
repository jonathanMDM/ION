...
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-lg shadow-md overflow-hidden">
        ...
        <div class="divide-y divide-gray-200">
            ...
            <div class="px-6 py-4 hover:bg-gray-50 transition-colors {{ $notification->read_at ? 'bg-white' : 'bg-blue-50' }}">
                        ...
                        <div class="flex items-start justify-between">
                            ...
                            <div class="flex items-center space-x-2 ml-4">
                                ...
                                <form action="{{ route('notifications.mark-as-read', $notification->id) }}" method="POST" class="inline">
                                    @csrf
                                    <button type="submit" class="text-xs text-indigo-600 hover:text-indigo-800" title="Marcar como leída">
        ...
        <div class="flex flex-col items-center justify-center py-12 text-gray-500">
            ...
            <h3 class="text-lg font-semibold mb-2">No tienes notificaciones</h3>
