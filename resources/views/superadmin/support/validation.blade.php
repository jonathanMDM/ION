...
<div class="max-w-4xl mx-auto">
    ...
    <!-- Results Section -->
    @if(isset($company))
    <div class="bg-green-50 border-l-4 border-blue-medium/500 rounded-lg shadow-md p-6 animate-fade-in-up">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
            <div class="bg-white p-4 rounded-lg shadow-sm border-l-4 border-blue-500">
                ...
                @if($company->subscription_expires_at)
                    ...
                    @endphp
                    <p class="text-xs mt-2 {{ $daysLeft < 30 ? 'text-red-600' : 'text-blue-medium' }}">
                        {{ $daysLeft > 0 ? $daysLeft . ' días restantes' : 'Expirada' }}
                    </p>
                @endif
            </div>

            <div class="bg-white p-4 rounded-lg shadow-sm border-l-4 border-blue-medium/500">
                <div class="flex items-center justify-between">
                    <div>
        ...
        <div class="mt-6 flex justify-end gap-4">
            ...
            <a href="{{ route('superadmin.tickets.create', ['company_id' => $company->id]) }}" class="bg-blue-medium hover:bg-blue-dark text-white font-bold py-2 px-4 rounded transition duration-200">
