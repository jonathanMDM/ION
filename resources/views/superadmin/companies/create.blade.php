                    ...
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            <p class="text-sm text-blue-700">
                                <strong>Contraseña Automática:</strong> Se generará una contraseña temporal y se enviará por correo electrónico al administrador. Deberá cambiarla en el primer inicio de sesión.
                            </p>
                        </div>
                    </div>
                </div>
