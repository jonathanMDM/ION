...
<div class="container mx-auto px-4 py-6">
    <div class="mb-6">
        <a href="{{ route('superadmin.companies.index') }}" class="text-blue-medium hover:text-indigo-900">
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <div class="flex items-center justify-between bg-gray-50 p-2 rounded">
                                            <div class="flex-1">
                                                ...
                                                @if($rule->is_visible)
                                                    <span class="text-xs bg-blue-lightest text-blue-dark px-2 py-1 rounded">Visible</span>
                                                @else
