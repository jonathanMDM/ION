    ...
    <table class="min-w-full">
        ...
        <tbody class="divide-y" style="divide-color: rgba(14, 104, 115, 0.1);">
            ...
            <tr class="hover:bg-white/5 transition-colors">
                ...
                <td class="px-6 py-4 whitespace-nowrap">
                    <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full {{ $company->status === 'active' ? 'bg-blue-lightest text-blue-dark' : 'bg-red-100 text-red-800' }}">
                ...
                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                    ...
                    <form action="{{ route('superadmin.backups.create', $company) }}" method="POST" class="inline-block mr-3">
                        @csrf
                        <button type="submit" class="text-blue-medium hover:text-green-900" title="Crear Backup">
                            <i class="fas fa-database"></i>
                        </button>
                    </form>
                    <a href="{{ route('superadmin.companies.show', $company) }}" class="text-blue-medium hover:text-green-900 mr-3" title="Ver Detalles y Facturación">
                        <i class="fas fa-eye"></i>
                    </a>
                    <a href="{{ route('superadmin.companies.edit', $company) }}" class="text-blue-medium hover:text-indigo-900 mr-3" title="Editar">
