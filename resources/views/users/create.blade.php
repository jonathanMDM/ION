                    ...
                    <div class="p-8 space-y-6">
                        <div>
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name') }}" 
                                class="w-full bg-gray-50 dark:bg-gray-900 border-gray-200 dark:border-gray-700 rounded-2xl py-3 px-4 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-medium transition-all font-bold" required placeholder="Ej: Diana Martínez">
                        </div>
                        ...
                        <div>
                            ...
                            <div class="relative group">
                                ...
                                <input type="email" name="email" id="email" value="{{ old('email') }}" 
                                    class="w-full bg-gray-50 dark:bg-gray-900 border-gray-200 dark:border-gray-700 rounded-2xl py-3 pl-11 pr-4 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-medium transition-all" required placeholder="diana@empresa.com">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="password" name="password" id="password" 
                                    class="w-full bg-gray-50 dark:bg-gray-900 border-gray-200 dark:border-gray-700 rounded-2xl py-3 px-4 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-medium transition-all font-mono" required placeholder="••••••••">
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-3 {{ Str::slug($category) }}-group">
                                ...
                                <label class="group flex items-center justify-between p-3 rounded-2xl bg-gray-50 dark:bg-gray-900/40 border border-transparent hover:border-blue-medium/500/30 transition-all cursor-pointer">
                                    ...
                                    <input type="checkbox" name="permissions[]" value="{{ $key }}" class="w-5 h-5 rounded-lg border-gray-300 text-blue-medium focus:ring-blue-medium/20 transition-all">
                                </label>
                                @endforeach
                            </div>
                        </div>
