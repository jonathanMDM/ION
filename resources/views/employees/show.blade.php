...
<div class="max-w-6xl mx-auto pb-12">
    ...
    <div class="flex items-center justify-between mb-8">
        <div class="flex items-center gap-4">
            <a href="{{ route('employees.index') }}" class="w-10 h-10 flex items-center justify-center rounded-full bg-white dark:bg-gray-800 shadow-sm border border-gray-100 dark:border-gray-700 text-gray-400 hover:text-blue-medium transition-all">
        ...
        <div class="flex items-center gap-3">
            <a href="{{ route('employees.edit', $employee->id) }}" class="px-5 py-2.5 bg-blue-medium hover:bg-blue-dark text-white font-bold rounded-xl transition-all shadow-lg shadow-blue-medium/20 flex items-center">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <div class="lg:col-span-1 space-y-6">
            <div class="bg-white dark:bg-gray-800 rounded-3xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
                ...
                <div class="px-6 pb-6 pt-0 -mt-12 text-center">
                    <div class="relative inline-block">
                        <div class="w-24 h-24 bg-white dark:bg-gray-900 rounded-2xl shadow-xl flex items-center justify-center text-3xl font-black text-blue-medium border-4 border-white dark:border-gray-800 mx-auto">
                            {{ substr($employee->first_name, 0, 1) }}{{ substr($employee->last_name, 0, 1) }}
                        </div>
                        <div class="absolute bottom-0 right-0 w-6 h-6 rounded-full border-2 border-white dark:border-gray-800 {{ $employee->status == 'active' ? 'bg-blue-medium' : 'bg-red-500' }}"></div>
                    </div>
                    ...
                    <div class="mt-6 flex flex-wrap justify-center gap-2">
                        <span class="px-3 py-1 bg-indigo-50 dark:bg-indigo-900/30 text-blue-medium dark:text-indigo-400 rounded-full text-[10px] font-black uppercase tracking-wider">
                            {{ $employee->department ?? 'General' }}
                        </span>
                        <span class="px-3 py-1 {{ $employee->status == 'active' ? 'bg-green-50 dark:bg-green-900/30 text-blue-medium dark:text-green-400' : 'bg-red-50 dark:bg-red-900/30 text-red-600 dark:text-red-400' }} rounded-full text-[10px] font-black uppercase tracking-wider">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div class="bg-blue-medium rounded-2xl p-4 text-white shadow-lg shadow-blue-medium/20">
                                ...
                                <tr class="group hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                                    ...
                                    <td class="bg-gray-50/50 dark:bg-gray-900/40 py-4 px-4 border-t border-b border-gray-100 dark:border-gray-700">
                                        @if($assignment->expected_return_date)
                                            <span class="px-3 py-1 rounded-full text-[10px] font-black uppercase {{ $assignment->expected_return_date->isPast() ? 'bg-red-100 text-red-700' : 'bg-green-100 text-blue-dark' }}">
                                    ...
                                    <td class="bg-gray-50/50 dark:bg-gray-900/40 rounded-r-2xl py-4 px-4 border-r border-t border-b border-gray-100 dark:border-gray-700 text-right">
                                        <a href="{{ route('assets.show', $assignment->asset->id) }}" class="p-2 bg-white dark:bg-gray-800 rounded-lg shadow-sm text-gray-400 hover:text-blue-medium transition-colors">
                            ...
                            <div class="relative">
                                ...
                                <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 p-5 bg-gray-50/50 dark:bg-gray-900/40 rounded-2xl border border-gray-100 dark:border-gray-700 group hover:border-emerald-500/30 transition-all">
                                    ...
                                    <div class="text-right">
                                        <a href="{{ route('assets.show', $assignment->asset->id) }}" class="text-[10px] font-black text-blue-medium dark:text-indigo-400 uppercase tracking-widest hover:underline">Ver Activo</a>
                                    </div>
                                </div>
                            </div>
                            @endforeach
