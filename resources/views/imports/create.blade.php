...
<div class="max-w-4xl mx-auto">
    <div class="bg-white p-4 md:p-6 rounded shadow mb-6">
        <h2 class="text-2xl font-bold mb-6">Importar Activos desde Excel</h2>
        ...
        <form action="{{ route('imports.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                <div class="mb-4">
                    ...
                    <p class="text-gray-600 text-sm mt-2">Descarga la plantilla con todos los encabezados correctos (incluyendo campos personalizados).</p>
                </div>

                <label class="block text-gray-700 text-sm font-bold mb-2" for="file">Archivo Excel</label>
                ...
                <p class="text-gray-600 text-xs italic mt-2">Formatos soportados: .xlsx, .xls, .csv</p>
            </div>
    ...
    <!-- Field Requirements -->
    <div class="bg-blue-50 border-l-4 border-gray-500 p-4 md:p-6 rounded shadow mb-6">
        ...
        <div class="space-y-4">
            <div class="bg-white p-4 rounded">
                <h4 class="font-semibold text-gray-800 mb-2">Columnas Obligatorias:</h4>
            ...
            <div class="bg-white p-4 rounded">
                <h4 class="font-semibold text-gray-800 mb-2">Columnas Opcionales:</h4>
                <ul class="list-disc list-inside space-y-1 text-sm text-gray-700">
            ...
            <div class="bg-white p-4 rounded">
                <h4 class="font-semibold text-gray-800 mb-2">Campos Personalizados (Opcionales):</h4>
                <ul class="list-disc list-inside space-y-1 text-sm text-gray-700">
    ...
    <!-- Example Template -->
    <div class="bg-green-50 border-l-4 border-green-500 p-4 md:p-6 rounded shadow">
